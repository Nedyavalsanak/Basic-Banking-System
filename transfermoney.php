...
.main_div
{
    width:100%;
    height:100vh;
    background-image:url('transact_img.jpg');
...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center">AXIS BANK</a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;width:400px;margin-left:600px;background-color:black;border-radius:10px;color:green;opacity:0.8" >
              <form method="POST">  
...
?> 
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:76px;margin-left:-350px;width:400px;background-color:black;border-radius:10px;height:300px;color:green;opacity:0.8;">
